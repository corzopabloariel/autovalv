            ...
            this.columnas().forEach( function( column ) {
                ...
                if( this.especificacion[ column.COLUMN ].TIPO == "TP_IMAGE" ) {
                    ...
                    if( info !== undefined ) {
                        ...
                        element += `<p class="text-center mt-1 position-relative" style="overflow:hidden"><input type="text" class="border-0 position-absolute" style="top:-30px; left:-30px" value="${imgURL}" id="copyURL"/><strong class="mr-1">URL:</strong><a href="${imgURL}" target="blank">${imgURL}<i class="fas fa-external-link-alt ml-2"></i></a><i onclick="copy( this , '${imgURL}' )" style="cursor:pointer;" class="far fa-copy ml-1"></i></p>`;
                    }
                }
