 ...
 * -----------------------------------------/
 * @date 10.2019
 * @last_change 07.10.2019
 * @version 0.2.1.1
 */
Pyrus = function ( e = null, dataPYRUS = null , urlFile = null, xmlHttpURL = null) {
	this.entidad = e;
    this.objeto = null;
    this.name = null;
    ...
    this.clean = function( CKEDITOR_ , name = null ) {
        for( let x in this.especificacion ) {
            if( CKEDITOR_ !== null ) {
    ...
    this.delete = function( t , alertify_ , url , id ) {
     ...
     */
    this.editor = function( CKEDITOR_ , id = "", multiple = null ) {
        ...
        dataAUX.forEach( function( x ) {
            ...
            buttons = `<td class="text-center">`;
                if( buttonsOK.indexOf( "c" ) >= 0 )
                    buttons += `<button style="width: 35px;" onclick="clone(this,'${id}')" class="btn text-center btn-info rounded-0" disabled><i class="far fa-clone"></i></button>`;
                if( buttonsOK.indexOf( "e" ) >= 0 )
                    buttons += `<button style="width: 35px;" onclick="edit(this,'${id}')" class="btn text-center rounded-0 btn-warning"><i class="fas fa-pencil-alt"></i></button>`;
                if( buttonsOK.indexOf( "d" ) >= 0 )
                    buttons += `<button style="width: 35px;" onclick="erase(this,'${id}')" class="btn text-center rounded-0 btn-danger"><i class="fas fa-trash-alt"></i></button>`;
                if( button !== null ) {
                    button.forEach( function( b ) {
                        buttons += `<button style="width: 35px;" onclick="${b.function}Function(this,'${id}')" class="btn text-center rounded-0 ${b.class}">${b.icon}</button>`;
                    });
                }
    ...
    this.one = function( url , callbackOK , callbackFail = null ) {
        axios.get( url, {
            responseType: 'json'
        })
        .then(function( res ) {
    ...
    this.show = function( CKEDITOR_ , url , data , identifierNAME = null , identifier = null ) {
        if( data === null ) {
                ...
                for(let i in rowElements) {
                    ...
                    rowElementos.forEach( function( e ) {
                        ...
                        if(e == "VACIO") {
                            ...
                            aux = this.inputAdecuado(this.especificacion[e], e, id, STR_class, OBJ_funcion, this.especificacion[e].PLACEHOLDER === undefined ? "" : this.especificacion[e].PLACEHOLDER, multiple);
                            ...
                            if( this.objeto.IDIOMAS !== undefined ) {
                                if( this.objeto.IDIOMAS[e] !== undefined ) {
                                    ...
                                    for( let j in this.objeto.IDIOMAS[ e ].ELEMENT ) {
                                        ...
                                        auxX = this.inputAdecuado(this.especificacion[e], `${e}_${j}`, id, STR_class, OBJ_funcion, placeholder , multiple);
                                        if(this.objeto.PLACEHOLDER !== undefined)
     ...
     * 
     */
    this.inputAdecuado = function( Object_ , element_name , id_name , STR_class , OBJ_funcion , placeholder , multiple_name = null ) {
        let names = {
     ...
     */
    this.constructorNames = function( names , addName = null ) {
        let Arr = {};
     ...
     */
    this.constructorFunction = function( function_ , STR_id ) {
        let aux = "";
    ...
    this.check = function( OBJ_elemento , names , STR_class , OBJ_funcion = null ) {
        let STR_funcion = "";
        let necesario = 0;
        let inputData = "";
        let input = "";
    ...
    this.inputString = function( Object_ , names , STR_type , STR_class , OBJ_funcion = null , placeholder = "" ) {
        let STR_funcion = "";
        let inputData = "";
		if( Object_.NECESARIO === undefined ) Object_.NECESARIO = 0;
        if( Object_.DISABLED === undefined ) Object_.DISABLED = 0;
    ...
    this.inputColor = function( OBJ_elemento , names , STR_class , OBJ_funcion = null , placeholder = "" ) {
        let STR_funcion = "";
        let necesario = 0;
        let inputData = "";
		if(OBJ_elemento.NECESARIO !== undefined) necesario = OBJ_elemento.NECESARIO;
    ...
    this.inputText = function( OBJ_elemento , names , STR_class , OBJ_funcion = null , placeholder = "" ) {
        let STR_funcion = "";
        let necesario = 0;
        if(OBJ_elemento.NECESARIO !== undefined) necesario = OBJ_elemento.NECESARIO;
        if(OBJ_elemento.DISABLED === undefined) OBJ_elemento.DISABLED = 0;
    ...
    this.select = function( OBJ_elemento , names , STR_class , OBJ_funcion , OBJ_datos = null , placeholder = null ) {
		let STR_funcion = "";
